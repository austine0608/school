...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="staff_info.php"> Staff Information </a>
                </li>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <form action="https://formsubmit.co/austinelakemfa@gmail.com" method="POST">
                Name: <br><input type="text" name="name" required><br><hr>
                Email <br><input type="text" name="email" required><br><hr>
                Phone: <br><input type="text" name="phone" required><br><hr>
                <input type="hidden" name="_captcha" value="false">
                <input type="hidden" name="_subject" value="New Message">
                <input type="hidden" name="_next" value="https://lakemfa.com/contact.html">
                Message: <br><textarea input type="text" name="message"rows="10px"cols="50px"></textarea><br><hr>
                <button type="submit">
                  send
                </button>
              </form>
  ...
  <section class="container-fluid footer_section">
    <p>
      ...
      <a href="https://html.design/">Lakemfa Schools</a>
    </p>
  </section>
  <!-- footer section -->
